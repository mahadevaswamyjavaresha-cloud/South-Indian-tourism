...
.hero {
height:70vh;
background:url('../assets/images/wayanad.jpg') no-repeat center/cover;
...
<div class="hero">Wayanad 🌿</div>

<div class="container">

<h2>About</h2>
<p>Wayanad is known for forests, wildlife, and mountains.</p>

<h2>Highlights</h2>
<div class="highlights">
<div class="box">🐘 Wildlife</div>
<div class="box">🌳 Forest</div>
<div class="box">⛰️ Hills</div>
<div class="box">🏞️ Nature</div>
</div>

<h2>Gallery</h2>
<div class="gallery">
<img src="../assets/images/wayanad1.jpg">
<img src="../assets/images/wayanad2.jpg">
<img src="../assets/images/wayanad3.jpg">
</div>

<h2>Location</h2>
<iframe src="https://www.google.com/maps?q=wayanad&output=embed"
