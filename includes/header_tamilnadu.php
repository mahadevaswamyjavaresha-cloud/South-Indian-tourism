...
<a href="/kerala/pages/tamilnadu_beaches.php" class="<?php if($currentPage=="tamilnadu_beaches.php") echo "active"; ?>">
<i class="fas fa-umbrella-beach"></i> Beaches
</a>

<a href="/kerala/pages/tamilnadu_hillstations.php" class="<?php if($currentPage=="tamilnadu_hillstations.php") echo "active"; ?>">
<i class="fas fa-mountain"></i> Hill Stations
</a>

<a href="/kerala/pages/tamilnadu_temples.php" class="<?php if($currentPage=="tamilnadu_temples.php") echo "active"; ?>">
