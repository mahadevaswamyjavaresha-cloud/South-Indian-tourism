...
<a href="/kerala/pages/andhra_beaches.php" class="<?php if($currentPage=="andhra_beaches.php") echo "active"; ?>">
<i class="fas fa-umbrella-beach"></i> Beaches
</a>

<a href="/kerala/pages/andhra_temples.php" class="<?php if($currentPage=="andhra_temples.php") echo "active"; ?>">
<i class="fas fa-place-of-worship"></i> Temples
</a>

<a href="/kerala/pages/andhra_caves.php" class="<?php if($currentPage=="andhra_caves.php") echo "active"; ?>">
